...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({ activeView, setActiveView }) => {
    ...
    const navItems = [
        { id: 'home', icon: <HomeIcon />, label: 'Home', view: 'home' as View },
        { id: 'search', icon: <SearchIcon />, label: 'Search', view: 'search' as View },
        { id: 'library', icon: <LibraryIcon />, label: 'Library', view: 'library' as View },
        { id: 'settings', icon: <SettingsIcon />, label: 'Settings', view: 'settings' as View },
    ];
